        ...
        <div className="tile short">
          <div className="tile-content">
            ...
            <span className="description">
              HTML, CSS, JS, React.js, Three.js , Nextjs 
            </span>
          </div>
        </div>
        <div className="tile short">
          <div className="tile-content">
            Backend <br />
            <span className="description">Node.js, Solidity, PHP, Java</span>
          </div>
        </div>
        <div className="tile short">
          <div className="tile-content">
            ...
            <br />
            <span className="description">
              Git, NPM, Linux, Bash, Web3js, MongoDB, Etherjs
           </span>
          </div>
        </div>
            <div className="tile short">
          <div className="tile-content">
           Tools 
            <br />
            <span className="description">
            Remix , Hardhat , Truffle , Ganache_cli
            </span>
          </div>
        </div>
